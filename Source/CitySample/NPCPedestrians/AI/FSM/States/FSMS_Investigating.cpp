...
void UFSMS_Investigating::BeginPlay(APawn* pawn, UWorld* world)
{
...
void UFSMS_Investigating::EnterState(APawn* pawn, UWorld* world)
{
...
void UFSMS_Investigating::TickState(float deltaTime, APawn* pawn)
{
