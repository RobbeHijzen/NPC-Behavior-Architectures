...
class CITYSAMPLE_API FSMT_ArePeopleConversing : public FSMTransition
{
public:

	FSMT_ArePeopleConversing(const UFSMState* toState, UWorld* world, APedestrian* pedestrian)
